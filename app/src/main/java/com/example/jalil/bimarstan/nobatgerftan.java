...
public class nobatgerftan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nobatgerftan);
...
//
//
//            Button turnEnter2 = (Button) findViewById(R.id.buttonsin);
//
            ...
            public void onClick(View arg0) {
                ...
                if(expertise!=-1){
                    ...
                    if (all){
                        ...
                        Intent myIntent = new Intent(G.activity,Nobatdokheli.class);
