...
public class Nobatdokheli extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nobatdokheli);
            ...
            if(s[0].equals("doctor")) {
                ...
                try {
                    ...
                    for (int i = 0; i < contacts.length(); i++) {
                        ...
                        ListStringInteger[index] = new StringAndIntegers(Integer.parseInt(id),name,salery_d,address,mobile);
...
//
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(Nobatdokheli.this,
                    "لطفاً منتظر بمانید",
                    "با تشکر");
        }
